...
public class ScoreStudentFragment extends Fragment {
    ...
    class TabPagerAdapter extends FragmentStatePagerAdapter {
        ...
        public android.support.v4.app.Fragment getItem(int position) {
            if (position == 0) {
                return new ScoreStudentSemesterFragment();
            } else {
                return new ScoreStudentYearFragment();
            }
        }
